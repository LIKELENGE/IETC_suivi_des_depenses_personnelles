...
def afficher_categorie_depense(id_categorie):
    ...
    return render_template("categorie_depense.html", categorie_depense=categorie_depense)
...
def ajouter_categorie_depense():
    if request.method == 'POST':
        ...
        categorie_depense = CategorieDepense(description=description,limite=limite,id_utilisateur=id_utilisateur)
...
def modifier_categorie_depense(id_categorie):
    ...
    if request.method == 'POST':
        ...
        updates = {"description": description, "limite": limite}
...
def supprimer_categorie_depense(id_categorie):
    ...
    return render_template("suppression_confirmation_categorie_depense.html", 
